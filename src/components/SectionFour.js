...
const SectionFour = ({ title, subtitle, image, companyLogos }) => {
  return (
    <div className="min-h-screen lg:p-20 md:px-10 p-6">
      <div className="flex w-full justify-between pb-20">
        <div className="pt-10">
          <h1 className="text-mainGreen md:text-[120px] text-6xl font-aonik leading-none">
            {title}
          </h1>
          <h2 className="text-black lg:text-[32px] text-2xl font-aonik w-11/12">
            {subtitle}
          </h2>
          <h3 className="text-black lg:text-2xl md:text-lg xs:text-base text-xl w-11/12 pt-4">
            ...
            <span
              ...
              href="mailto:investor@algorand.foundation"
            >
              loremipsum@algorand.foundation
            </span>
            <br />
